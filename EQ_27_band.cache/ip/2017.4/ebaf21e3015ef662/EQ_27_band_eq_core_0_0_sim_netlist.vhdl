...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_eq_core_v1_0_S00_AXI is
  ...
  signal next_cntr : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \cntr[3]_i_1\ : label is "soft_lutpair4";
...
\Rz0[35]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\Rz2[35]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000080000000000"
    )
        port map (
...
\data_R_out[31]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
