...
################################################################
# This is a generated script based on design: EQ_27_band
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_i2s_receiver_0, and set properties
  set axi_i2s_receiver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_i2s_receiver:1.0 axi_i2s_receiver_0 ]

  # Create instance: axi_i2s_transmitter_0, and set properties
  set axi_i2s_transmitter_0 [ create_bd_cell -type ip -vlnv DelHatch:user:axi_i2s_transmitter:1.0 axi_i2s_transmitter_0 ]

  set_property -dict [ list \
   CONFIG.TDATA_NUM_BYTES {4} \
   CONFIG.HAS_TSTRB {1} \
 ] [get_bd_intf_pins /axi_i2s_transmitter_0/s_axis]
  ...
  set_property -dict [ list \
   CONFIG.TDATA_NUM_BYTES {4} \
   CONFIG.HAS_TSTRB {1} \
 ] [get_bd_intf_pins /eq_core_0/m_axis]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /eq_core_0/s00_axi]
  ...
  connect_bd_intf_net -intf_net axi_i2s_receiver_0_M_AXIS [get_bd_intf_pins axi_i2s_receiver_0/M_AXIS] [get_bd_intf_pins eq_core_0/s_axis]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins eq_core_0/s00_axi]
  ...
  connect_bd_intf_net -intf_net eq_core_0_m_axis [get_bd_intf_pins axi_i2s_transmitter_0/s_axis] [get_bd_intf_pins eq_core_0/m_axis]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports iic_0] [get_bd_intf_pins processing_system7_0/IIC_0]

  # Create port connections
  connect_bd_net -net axi_i2s_transmitter_0_bclk [get_bd_ports BCLK] [get_bd_pins axi_i2s_receiver_0/bclk] [get_bd_pins axi_i2s_transmitter_0/bclk]
  connect_bd_net -net axi_i2s_transmitter_0_lrclk [get_bd_ports LRCLK] [get_bd_pins axi_i2s_receiver_0/lrclk] [get_bd_pins axi_i2s_transmitter_0/lrclk] [get_bd_pins eq_core_0/lrclk]
  ...
  connect_bd_net -net sdata_0_1 [get_bd_ports SDATA_I] [get_bd_pins axi_i2s_receiver_0/sdata]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs eq_core_0/s00_axi/reg0] SEG_eq_core_0_reg0
