...
`timescale 1 ns / 1 ps
	...
	(
        ...
        output reg [C_S_AXIS_TDATA_WIDTH-1:0] data_L,
        output reg [C_S_AXIS_TDATA_WIDTH-1:0] data_R,
		// User ports ends
    ...
    always @ ( posedge S_AXIS_ACLK ) Y <= lrclk;  // Pulse every lrclk rising edge. Starts the data transfer from the Master.
    ...
    assign fifo_wren = S_AXIS_TVALID && axis_tready;
	    ...
	    // Streamed L/R input data is stored into two registers.
	always @( posedge S_AXIS_ACLK ) begin
