...
HD_PWD='C:/Zynq_Book/EQ_27_band/EQ_27_band.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EQ_27_band_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EQ_27_band_wrapper.tcl -notrace
