...
HD_PWD='C:/Zynq_Book/EQ_27_band/EQ_27_band.runs/EQ_27_band_axi_i2s_transmitter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EQ_27_band_axi_i2s_transmitter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EQ_27_band_axi_i2s_transmitter_0_0.tcl
